    ...
    return Scaffold(
      ...
      bottomNavigationBar: SafeArea(
        child: Container(
          ...
          padding:
              const EdgeInsets.only(left: 24, right: 24, top: 12, bottom: 4),
          child: GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed(Routes.yourPostCompletedScreen);
              },
              child: AppWidget.typeButtonStartAction(input: 'POST YOUR ADS')),
        ),
      ),
    );
  }
