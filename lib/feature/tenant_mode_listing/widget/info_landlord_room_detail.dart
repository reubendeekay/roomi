...
import 'package:roomy/feature/tenant_mode_listing/widget/space_location.dart';
    ...
    return Column(children: [
        ...
        child: Column(
          ...
          children: [
            currentRoommates != null
                ...
                : const SizedBox(),
            currentRoommates != null
                ? LandlordDetailWidget.createText(text: currentRoommates.first)
                : const SizedBox(),
            currentRoommates != null
                ? Padding(
      ...
      GestureDetector(
          ...
          child: SizedBox(
              ...
              child: SpaceLocation(
                location: LatLng(
                    room.post.location.latitude, room.post.location.longitude),
                imageUrl: room.post.images.first,
              )))
    ]);
  }
}
