...
class SavedBookScreen extends StatefulWidget {
  @override
  _SavedBookScreenState createState() => _SavedBookScreenState();
}

class _SavedBookScreenState extends State<SavedBookScreen> {
  @override
